...
## 10.
png("глюкоза_по_полу.png", width = 800, height = 600)
...
## 12. 
sum_na <- sum(is.na(patients_task))
cat("Общее количество пропущенных значений:", sum_na, "\n")
...
## 18.
write.csv(final_result, file = "анализ_гемоглобина.csv", row.names = FALSE, fileEncoding = "UTF-8")


cat("Текущая рабочая директория:", getwd(), "\n")
